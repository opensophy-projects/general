  ...
  const accordionItems = [
    {
      ...
      content: "Opensophy — это коллекция open-source ресурсов для IT-специалистов. Мы собираем и создаем проекты, шаблоны, UI компоненты и образовательный контент с фокусом на безопасность и best practices."
    },
    {
      id: "item-2",
    ...
    },
    {
      ...
      content: "Все материалы находятся в открытом доступе. Вы можете свободно использовать компоненты в своих проектах, читать документацию и применять описанные практики. Код доступен на GitHub."
    },
    {
      id: "item-4",
    ...
    },
    {
      ...
      content: "Основной контент представлен на русском и английском языках. Не стесняйтесь писать на предпочитаемом вам языке."
    },
    {
      id: "item-6",
